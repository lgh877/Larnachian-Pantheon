...
import net.mcreator.larnachianpantheon.client.renderer.LarnachsRenderState;
...
public class ModelLarnachs extends EntityModel<LarnachsRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("larnachian_pantheon", "model_larnachs"), "main");
