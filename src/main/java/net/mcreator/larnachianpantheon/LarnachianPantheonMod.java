...
import net.mcreator.larnachianpantheon.init.LarnachianPantheonModTabs;
import net.mcreator.larnachianpantheon.init.LarnachianPantheonModItems;
...
@Mod("larnachian_pantheon")
public class LarnachianPantheonMod {
	public static final Logger LOGGER = LogManager.getLogger(LarnachianPantheonMod.class);
	public static final String MODID = "larnachian_pantheon";

	public LarnachianPantheonMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		LarnachianPantheonModItems.REGISTRY.register(modEventBus);
		LarnachianPantheonModEntities.REGISTRY.register(modEventBus);
		LarnachianPantheonModTabs.REGISTRY.register(modEventBus);
