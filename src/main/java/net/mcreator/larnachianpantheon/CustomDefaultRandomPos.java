...
public class CustomDefaultRandomPos {
    /*
	@Nullable
	private static BlockPos generateRandomPosTowardDirection(PathfinderMob p_148437_, double p_148438_, boolean p_148439_, BlockPos p_148440_) {
	...
	@Nullable
	public static Vec3 getPosStrafe(PathfinderMob mob, double horizontalRange, double verticalRange, Vec3 targetPos) {
