						...
						if (actionTicks == 0) {
							...
							if (world instanceof Level _level) {
								if (!_level.isClientSide()) {
									_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("item.trident.throw")), SoundSource.HOSTILE, 2, (float) 0.5);
								} else {
									_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("item.trident.throw")), SoundSource.HOSTILE, 2, (float) 0.5, false);
								}
							}
					...
					case 43 :
						if (actionTicks == 0) {
							...
							if (entity.onGround()) {
								if (world instanceof Level _level) {
									if (!_level.isClientSide()) {
										_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("entity.zombie.attack_iron_door")), SoundSource.HOSTILE, 2, (float) 0.5);
									} else {
										_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("entity.zombie.attack_iron_door")), SoundSource.HOSTILE, 2, (float) 0.5, false);
									}
								}
							} else {
								mob.actionTicks = 0;
